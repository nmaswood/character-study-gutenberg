...
export const BookAnalysisSchema: Schema = {
    ...
    properties: {
            ...
            items: {
                ...
                properties: {
                    ...
                    relationships: {
                        type: SchemaType.ARRAY,
                        description:
                            "List of relationships the character has, maximum 5",
                        items: {
                            type: SchemaType.STRING,
                        },
                        nullable: false,
                    ...
                    quotes: {
                        type: SchemaType.ARRAY,
                        description:
                            "List of notable quotes from the character, maximum 5",
                        items: {
                            type: SchemaType.STRING,
                        },
                        nullable: false,
        ...
        plotEvents: {
            description:
                "List of significant events and the relevant characters",
            type: SchemaType.ARRAY,
            items: {
                type: SchemaType.OBJECT,
                properties: {
                    ...
                    charactersInEvent: {
                        description:
                            "Full names of characters involved the event",
                        type: SchemaType.ARRAY,
                        items: {
                            type: SchemaType.STRING,
                        },
