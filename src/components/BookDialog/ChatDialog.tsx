...
export default function ChatDialog({
	...
	return (
		<div className="p:2 sm:max-w-1/2 flex h-full w-full flex-col justify-between overflow-auto sm:p-4 md:max-h-fit md:w-1/2">
			...
			<div className="flex justify-between border-b-2 border-gray-200 py-3 sm:items-center">
				<div className="relative flex items-center space-x-4">
					<div className="flex flex-col leading-tight transition-all duration-300">
						...
						<span
							className={`text-xs md:block md:text-lg ${chatHistory.length !== 0 && "hidden"}`}
			...
			{/* Chat Window */}
			<div className="flex min-h-[200px] flex-col justify-start space-y-4 overflow-y-auto p-3 md:min-h-[400px]">
